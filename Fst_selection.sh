##following commands should be done with two references A.hyacinthus and A.cyhtehrea each
...
diff sub_bif_filtered.weir.fst_08.sites sub_cyt_filtered.weir.fst_08.sites|grep ">"|sed "s/_/\t/g" > //g" >sub_cyt_specific_ag_sub_bif
diff sub_hya_filtered.weir.fst_08.sites sub_cyt_specific_ag_sub_bif|grep ">"|sed "s/> //g"|sed "s/_/\t/g" >sub_cyt_specific
